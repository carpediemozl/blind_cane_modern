...
# --- 1. 核心参数 ---
MODEL_PATH = 'models/knottedblob/knottedtrafficlightv5.blob'
...
spatial_nn.setDepthUpperThreshold(65535)
# YOLOv4 参数
spatial_nn.setNumClasses(3)
spatial_nn.setCoordinateSize(4)
#spatial_nn.setAnchors(np.array([10, 13, 16, 30, 33, 23, 30, 61, 62, 45, 59, 119, 116, 90, 156, 198, 373, 326]))
#spatial_nn.setAnchorMasks({"side80": [0, 1, 2], "side40": [3, 4, 5], "side20": [6, 7, 8]})
#spatial_nn.setAnchors(np.array([5,6, 8,14, 15,11,10, 13, 16, 30, 33, 23, 30, 61, 62, 45, 59, 119, 116, 90, 156, 198, 373, 326]))
#spatial_nn.setAnchorMasks({"side104": [0, 1, 2], "side52": [3, 4, 5], "side26": [6, 7, 8], "side13": [9, 10, 11]})
spatial_nn.setAnchors(np.array([5,6, 8,14, 15,11,10, 13, 16, 30, 33, 23, 30, 61, 62, 45, 59, 119, 116, 90, 156, 198, 373, 326]))
spatial_nn.setAnchorMasks({"side160": [0, 1, 2],"side80": [3, 4, 5], "side40": [6, 7, 8], "side20": [9, 10, 11]})
        ...
        while True:
            ...
            for detection in detections:
                ...
                COLORS = {
                    "Red": (0, 0, 255),
                    "Green": (0, 255, 0),
                    "Yellow": (0, 255, 255), # 为Yellow指定黄色
                }
                # 根据标签获取颜色，如果找不到就用默认的白色
